...
function install (args, cb) {
  ...
  steps.push(
    ...
    [function (cb) { cb(null, completion.loadCurrentTree.finish()) }],
    [loadIdealTree, args, installState],
    [function (cb) { cb(null, completion.loadIdealTree.finish()) }],
    ...
    [function (cb) { cb(null, completion.generateActionsToTake.finish()) }],
    ...
    [function (cb) { cb(null, completion.executeActions.finish()) }],

    [runTopLevelLifecycles, args, installState],
    [function (cb) { cb(null, completion.runTopLevelLifecycles.finish()) }])
